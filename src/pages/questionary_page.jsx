    ...
    <div className='questionary-page'>
      ...
      {page === 4 && (
        <div>
          ...
          <p>Gracias por completar el cuestionario. Tus respuestas te ayudan a entender mejor los factores que influyen en tu bienestar diario.</p>
          <p>Recuerda que pequeños cambios pueden hacer una gran diferencia. Te invitamos a seguir reflexionando sobre tu bienestar y a cuidarte cada día.</p>
          <br />
